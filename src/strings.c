...
const u8 gText_LeagueChamp[] = _("TWO CHAMPION! CONGRATULATIONS!\n{FONT_SMALL}RESPAWN: {STR_VAR_1}   RESTART: {STR_VAR_2}   STEPS: {STR_VAR_3}");
...
const u8 gText_TrainerCardMoney[] = _("RESPAWN");
const u8 gText_TrainerCardRestart[] = _("RESTART");
...
const u8 gText_SavingBadges[] = _("STAGES");
