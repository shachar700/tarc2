...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNWATCHINGCAREFULLY]                = COMPOUND_STRING("{B_PLAYER_NAME} tried to sway {B_OPPONENT_MON1_NAME} to let its guard down…"/*{B_OPPONENT_MON1_NAME} is watching carefully!"*/), //safari
    [STRINGID_PKMNSWAYSUCCESS]                      = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} let its guard down!"), 
...
const u8 gText_BattleMenu[] = _("Battle{CLEAR_TO 56}Sway\nPokémon{CLEAR_TO 56}Run");
