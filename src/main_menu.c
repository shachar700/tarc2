...
//static void Task_BirchSpeech_ShowMainSpeechText(u8);
//static void Task_BirchSpeech_ShowAreYouReadyText(u8);
//static void Task_BirchSpeech_WaitAfterWelcome(u8);
...
static const u8 gText_ContinueMenuBadges[] = _("STAGES");
...
static const u8 *const sMalePresetNames[] = {
    COMPOUND_STRING("TWO-DOH"),
};

static const u8 *const sFemalePresetNames[] = {
    COMPOUND_STRING("TWODETTE"),
};
...
static void Task_NewGameBirchSpeech_Init(u8 taskId)
{
    ...
    PlayBGM(MUS_INTRO_MYSTERY/*MUS_ROUTE122*/);
    ShowBg(0);
    ShowBg(1);
}
